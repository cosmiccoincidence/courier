...
func apply_equipment_stats():
	...
	print("Equipment stats applied to player")
	print("  Gear Armor: %d" % gear_stats.armor)
	print("  Gear Strength: %d" % gear_stats.strength)
	print("  Gear Fire Resist: %.0f%%" % (gear_stats.fire_resistance * 100))
